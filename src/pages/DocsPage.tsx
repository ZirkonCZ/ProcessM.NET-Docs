  ...
  return (
    ...
    >
      ...
      <SidebarInset>
        ...
        <h1 className="h1" id="introduction">Introduction To Process Mining</h1>
        <p className="p" id="overview">
        ...
        <ol className="ol">
          <li className="li h2" id="process-mining-concepts">
            Process Mining Concepts
          </li>
          <ul className="ul">
            <li className="li" id="process">
            ...
            <li className="li" id="process-models">
          ...
          <li className="li h2" id="basic-process-mining-techniques">
          ...
          <ul className="ul">
            ...
            <li className="li" id="process-discovery">
            ...
            <li className="li" id="conformance-checking">
            ...
            <li className="li" id="process-enhancement">
          ...
          <li className="li h2" id="process-model-representation">
          ...
          <ul className="ul">
            ...
            <li className="li" id="directly-follows-graphs">
          ...
          <li className="li h2" id="imperative-process-mining">
          ...
          <ul className="ul">
            <li className="li" id="alpha-algorithm">
            ...
            <li className="li" id="heuristic-miner">
            ...
            <li className="li" id="optimal-alignments">
          ...
          <li className="li h2" id="declarative-process-mining">
          ...
          <ul className="ul">
            <li className="li" id="declare-language">
            ...
            <li className="li" id="declarative-conformance-checking">
